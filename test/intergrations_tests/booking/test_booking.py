...
@pytest.mark.parametrize("cottage_id,date_start ,date_end , status_code" , [
    (1,"2025-11-07","2025-11-08",200 ),
    (1,"2025-11-07","2025-11-08",401 )
])
...
@pytest.mark.parametrize("cottage_id, date_start, date_end, count, status_code", [
