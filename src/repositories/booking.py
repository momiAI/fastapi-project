...
class BookingRepository(BaseRepository):
    ...
    async def booked_cottage_or_no(self, id_cott : int, date_start : date, date_end : date):
        query = await booked_cottages(id_cott=id_cott,date_start=date_start, date_end= date_end)
